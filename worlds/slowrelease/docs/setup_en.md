...
- Download both [universal-tracker](https://github.com/FarisTheAncient/Archipelago/releases) and [Slow Release Client](https://github.com/gjgfuj/AP-SlowRelease/releases) apworlds.
- Move them in your `Archipelago/custom_worlds` folder.
...
- The `/region_mode` command makes the slow release client act more like a player by handling one region of the world at a time.
